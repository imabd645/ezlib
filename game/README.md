# game — GUI Game Engine for EZ

> **Version:** 1.0  
> **Import:** `use "game"`  
> **File:** `C:\ezlib\game\main.ez`  
...
`game` is a real-time game engine for EZ built on native GDI and Windows Multimedia APIs. It provides:
...
*Documentation generated from `C:\ezlib\game\main.ez` — EZ Game Engine Library*
