...
ncrypt.NCryptExportKey(key, None, "ECCPRIVATEBLOB", None, None, 0, ctypes.byref(cbResult), 0)
buf = ctypes.create_string_buffer(cbResult.value)
ncrypt.NCryptExportKey(key, None, "ECCPRIVATEBLOB", None, buf, cbResult.value, ctypes.byref(cbResult), 0)
