...
# Set Export Policy
NCRYPT_ALLOW_EXPORT_FLAG = ctypes.c_uint32(1)
ncrypt.NCryptSetProperty(key, "Export Policy", ctypes.byref(NCRYPT_ALLOW_EXPORT_FLAG), 4, 0)
...
print("Export size res:", hex(res), "size:", cbResult.value)
if cbResult.value > 0:
