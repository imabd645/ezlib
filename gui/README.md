# gui — GUI Desktop Application Library for EZ

> **Version:** 1.0  
> **Import:** `use "gui"`  
> **File:** `C:\ezlib\gui\main.ez`  
...
`gui` is a high-level, object-oriented desktop GUI library for EZ, built on native EZ GUI built-ins. It provides:
...
After `use "gui"`, a `gui` global dictionary provides the main entry points.
...
*Documentation generated from `C:\ezlib\gui\main.ez` — EZ GUI Library*